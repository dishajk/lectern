...
\begin{enumerate}
    ...
    \item[Step 7.] From one of the trapeziums cut one square and one right angle triangle.
    \item[Step 8.] From the other trapezium, cut one parallelogram and one right angle triangle.
\end{enumerate}
\begin{figure}
    \centering
    \begin{tikzpicture}
