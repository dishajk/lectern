...
\begin{frame}
  ...
  %  \pdfpcmovie[autostart,width=0.8\linewidth,height=0.6\linewidth,autostart]{Click}{maths-circle.mp4}
    % \includemedia[width=0.75\textwidth,activate=onclick,playbutton=plain,addresource=maths-circle.mp4]{\includegraphics{ICTS-RRI-2.jpg}}{maths-circle.swf}
    \movie[width=0.8\linewidth,height=0.6\linewidth,showcontrols,autostart]{\includegraphics[width=0.8\linewidth]{ICTS-RRI-2.jpg}}{maths-circle.mp4}
    % \includemedia[activate=onclick]{\includegraphics{ICTS-RRI-2.jpg}}{maths-circle.swf}
  \end{center}
  % \includegraphics[width=0.5\linewidth]{ICTS-RRI-1.jpg} 
  % \hyperlinkmovie[showcontrols]{\includegraphics{ICTS-RRI-2.jpg}}{\beamerbutton{Show the middle stage}}
...
\begin{frame}
  \frametitle{Thanks}
  \textit{We would like to thank -\\
  CPTUM 2025 Organizing Committee,\\
  Tulsi Srinivasan, Mohan R, Jayasree S,\\
  everyone at MTA(I),\\
  our colleagues at ICTS-TIFR,\\
  our collaborators at RRI, JN Planetarium,\\
  Maths Circle India network}
\end{frame}
\end{document}